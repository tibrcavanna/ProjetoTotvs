...
User Function BENEFARQ()
	...
	TNewProcess():New("BENEFARQ", "Exportacao dos arquivos de beneficios", {|oSelf| ProcessBnf(oSelf)}, "Esta rotina processa e gera arquivo de beneficios para integracao", cVBPerg, NIL, NIL, NIL, NIL, .T., .F.) // "Exportacao dos arquivos de beneficios" - "Esta rotina processa e gera arquivo de beneficios para integracao"
Return
