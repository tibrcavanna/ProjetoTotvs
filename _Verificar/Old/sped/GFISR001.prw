...
Local cDesc2        := "demonstrativo dos status das notas fiscais de saida "
Local cDesc3        := ""
Local cPict         := ""
Local titulo       	:= "Demonstrativo Status NF Saida"
Local nLin          := 80
Local Cabec1		:= "Filial Num Nf    Serie Dt Emissao  Dt Cancelamento Cliente Loja Nome                           UF Chave Nfe                                    Status"
Local Cabec2       	:= ""
Local imprime      	:= .T.
Local aOrd        	:= {}
Private lEnd       	:= .F.
...
Local cDtCanc   := ""
Local cEst      := ""
Local cTitulo  	:= "Demonstrativo Status NF Saida"
Local aListBox  := {}
Local aParam    := {}
Local aCabec    := {}
Local aItens    := {}
