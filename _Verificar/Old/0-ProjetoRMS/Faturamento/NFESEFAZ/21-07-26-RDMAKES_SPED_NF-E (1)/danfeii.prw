...
#DEFINE MAXCODPRD  060					// Máximo de caracteres do codigo de produtos/servicos conforme o tamanho do quadro "Cod. prod"
...
If nTipo <> 1
	...
	PRIVATE oFont06    := TFontEx():New(oDanfe,"Times New Roman",05,05,.F.,.T.,.F.)// 13
...
If Type("oNF:_InfNfe:_infAdic:_infCpl:TEXT")<>"U"
	...
	EndDo
//	aadd(aMensagem,"PED.CLIENTE: 4900221796 ITEM: 010 ")
EndIf
/*
dbSelectArea("SF1")
dbSetOrder(1)
...
For nY := 1 To nLenItens
	...
	Else
		...
		nAuxH2 := len(aAux[1][7][nY]) + (nAuxH + (aTamCol[7]) - RetTamTex(aAux[1][7][nY], oFont06:oFont, oDanfe))
		oDanfe:Say(nLinha, nAuxH2 + 2, aAux[1][7][nY], oFont06:oFont) // QUANT
		nAuxH += aTamCol[7]
		...
		nAuxH2 := len(aAux[1][8][nY]) + (nAuxH + (aTamCol[8]) - RetTamTex(aAux[1][8][nY], oFont06:oFont, oDanfe))
		oDanfe:Say(nLinha, nAuxH2 + 5, aAux[1][8][nY], oFont06:oFont) // V UNITARIO
		nAuxH += aTamCol[8]
		...
		nAuxH2 := len(aAux[1][9][nY]) + (nAuxH + (aTamCol[9]) - RetTamTex(aAux[1][9][nY], oFont06:oFont, oDanfe))
		oDanfe:Say(nLinha, nAuxH2 + 5, aAux[1][9][nY], oFont06:oFont) // V. TOTAL
		nAuxH += aTamCol[9]
		...
		nAuxH2 := len(aAux[1][10][nY]) + (nAuxH + (aTamCol[10]) - RetTamTex(aAux[1][10][nY], oFont06:oFont, oDanfe))
		oDanfe:Say(nLinha, nAuxH2 + 5, aAux[1][10][nY], oFont06:oFont) // BC. ICMS	
		nAuxH += aTamCol[10]
		...
		nAuxH2 := len(aAux[1][11][nY]) + (nAuxH + (aTamCol[11]) - RetTamTex(aAux[1][11][nY], oFont06:oFont, oDanfe))
		oDanfe:Say(nLinha, nAuxH2 + 5, aAux[1][11][nY], oFont06:oFont) // V. ICMS
		nAuxH += aTamCol[11]
		...
		nAuxH2 := len(aAux[1][12][nY]) + (nAuxH + (aTamCol[12]) - RetTamTex(aAux[1][12][nY], oFont06:oFont, oDanfe))
		oDanfe:Say(nLinha, nAuxH2 - 2 , aAux[1][12][nY], oFont06:oFont) // V.IPI			
		nAuxH += aTamCol[12]
