...
//DbselectArea("RHP")
//RHP->( DbSetOrder( 1 ) )
//DbSeek(xFilial("RHP")+cEmpAnt+SPACE(06)) //space devido o campo ter 8 caracteres e só é preenhido com 2
...
msgrun("Gerando Informações para DIRF, Aguarde !!!")
/*
DbselectArea("RHP")
RHP->( DbSetOrder( 1 ) )
...
//	putSx1(cPerg, '02', 'Até Data:' 	, '', '', 'mv_ch2' , 'C', 					    6, 0, 0, 'G', '',       '', '', '', 'mv_par02')
//Return
