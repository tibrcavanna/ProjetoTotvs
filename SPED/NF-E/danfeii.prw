...
#DEFINE MAXVALORC  016 //009			// Máximo de caracteres por linha de valores numéricos //#CAVANNA
#DEFINE MAXCODPRD  060 //050			// Máximo de caracteres do codigo de produtos/servicos conforme o tamanho do quadro "Cod. prod" //#CAVANNA
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	If ( oDet[nX]:_Prod:_uTrib:TEXT <> oDet[nX]:_Prod:_uCom:TEXT ) .and. MV_PAR04 == 2 //.And. .F. //#CAVANNA
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	Local nMax	:= 0
	Local nY   	:= 0
	Default nTamanho := 60 //45 #CAVANNA
...
Static Function RetTamCol(aCabec, aValores, oPrinter, oFontCabec, oFont)
	...
	*/		
	...
	22,;
		15,;
		iif(aCabec[4] == "CSOSN", 33, 35),; // Quant. //#CAVANNA
	iif(aCabec[4] == "CSOSN", 49, 63),; // V.Unitário //53 //#CAVANNA
	48,; //38
	37,;
		32,;
		32,;
...
Valida o estilo de fonte caso for PDF ou SPOOl.F
@type function
@version V12 P2210
